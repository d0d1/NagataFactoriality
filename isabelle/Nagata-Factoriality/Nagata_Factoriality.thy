...
text \<open>
  ...
  set.  The present entry packages the prime-generated core, a wrapper
  ...
  @{text Nagata_Lemmas}.  That theory also packages theorem-level
  ...
  package abstract polynomial applications for localization away from @{text X}
  and for localizations generated by constant prime polynomials, cf.\ Nagata and
