...
3. Decide whether the next mathematical strengthening step should be a broader application, such as an iterated Laurent/polynomial result.
4. Decide whether to split the upstreamable localization API into a separate Mathlib-facing contribution.
