...
4. A theorem-driven Laurent-polynomial application showing how the corrected Nagata theorem can recover a polynomial UFD result from a localization hypothesis.
...
- 970 Lean source lines under `NagataFactoriality\`
- 74 theorem/lemma declarations
...
- The current theorem surface is stronger than the original draft, but the application layer is still intentionally compact; a publication can still strengthen the examples and exposition.
